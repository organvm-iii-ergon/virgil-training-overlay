...
func getSanitizedAppName(_ name: String?) -> String {
    ...
    // Optimization: decoding from UTF8 view is faster and handles multibyte truncation safely
    ...
    // Optimization: Iterate scalars with pre-allocated capacity instead of split/join
    var result = ""
