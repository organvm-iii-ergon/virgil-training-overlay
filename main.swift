...
func getSanitizedAppName(_ name: String?) -> String {
    ...
    // Optimization: Pre-allocate memory based on UTF-8 count to avoid reallocations.
    // Iterating unicodeScalars avoids creating intermediate arrays (components/joined).
    var result = ""
